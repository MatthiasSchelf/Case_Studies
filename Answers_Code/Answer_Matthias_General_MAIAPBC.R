...
# Columns of interest
columns_of_interest <- c("PBC", "MAIA_trusting", "MAIA_body_listening", "MAIA_self_regulation",
                         "MAIA_emotional_awareness", "MAIA_attention_regulation", "MAIA_not_worrying",
                         "MAIA_not_distracting", "MAIA_noticing")
...
# Estimate network using EBICglasso with tuning parameter to indicate how harsh it needs to be.
